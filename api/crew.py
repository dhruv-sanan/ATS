...
from agents import CompanyResearchAgents, EmailPersonalizationAgents, HRAgents
from job_manager import append_event
from tasks import CompanyResearchTasks, PersonalizeEmailTask, HRTask
...
class HRCrew:
    ...
    def setup_crew(self, pdf_content, jd):
        ...
        self.crew = Crew(
            agents=[
                score_HR_agent, explain_HR_agent
            ],
            tasks=[
                score_HR, explain_HR
            ],
